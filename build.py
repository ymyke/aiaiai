...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    .page-mark:hover {{ color: var(--accent) !important; text-decoration: none; }}
    html[data-theme="dark"] .page-mark {{ color: #555; }}
    html[data-theme="dark"] .page-mark:hover {{ color: #a78bfa !important; }}
...
<body>
  ...
  <a href="index.html" class="page-mark" title="Home"><svg viewBox="0 0 64 64" style="width:3rem;height:3rem"><text x="4" y="48" fill="currentColor" font-family="'Fira Code',monospace" font-size="48" letter-spacing="-0.2em">·&gt;</text></svg></a>
  <script>
    (function() {{
